...
@Component({
  selector: 'app-job-group-add-new',
  standalone: true,
  imports: [ReactiveFormsModule, RouterLink],
  templateUrl: './job-group-add-new.component.html',
  styleUrl: '../shared/crud-page.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class JobGroupAddNewComponent {
  ...
  submit(): void {
    ...
    this.jobGroupService
      ...
      .subscribe({
        ...
        error: (err: unknown) => {
          this.errorMessage.set(formatHttpError(err, 'Could not create job group.'));
        },
      });
  }
}
